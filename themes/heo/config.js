const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    ...
    { title: 'Notion OS for One-person Companies', url: 'https://1person.so' },
    {
      title: '加入独立开发出海社区⛴️',
  ...
  HERO_TITLE_2: 'The Dawn of Super-individuals',
  ...
  HERO_CATEGORY_2: { title: 'Community', url: '/tag/community' },
  HERO_CATEGORY_3: { title: 'Product', url: '/tag/product' },
