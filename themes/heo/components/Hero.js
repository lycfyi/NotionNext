  ...
  return (
    ...
    >
      <div
        ...
        style={{ zIndex: 1 }}
        className={
          'animate__animated animate__fadeIn animate__fast recent-post-top rounded-[12px] 2xl:px-5 recent-top-post-group max-w-[86rem] overflow-x-scroll w-full mx-auto flex-row flex-nowrap flex relative space-x-3'
        }
      >
        {/* 左侧banner组 */}
        <BannerGroup {...props} />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          'opacity-0 group-hover:opacity-100 duration-300 transition-all bg-[#4259efdd] dark:bg-[#dca846] dark:text-white cursor-pointer absolute w-full h-full top-0 flex justify-start items-center'
        }
      >
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "url('https://pub-6ca6f004571f413b9600ebeb724536f6.r2.dev/product_cover_photo2.png') no-repeat center /cover"
          }}
        ></div>
      </div>
    </div>
